...
# Para evitar erro de estrutura de copiar o código
# link do colab: https://colab.research.google.com/drive/1dOYTufvcGU_UD5yOk8GFH_V0AsWS4C7w?usp=sharing
...
print('Bem vindo ao controle de Estoque da bicicletaria do Daniel Melentovytch Santos RU: 4464640')
while True:
    try:
